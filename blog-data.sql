...
insert into user(username, password, first_name, last_name, email, is_active, is_expired, created, updated)
values ('Administrator', 'Adm5lms8H4', 'Анна', 'Елизарова', 'anna_yelis@gmail.com', 1, 1, current_timestamp, current_timestamp);
...
values ('Салат оливье', 'Все об оливье', current_timestamp, current_timestamp, 1, 12, 1),
       ('Все о законе №555', 'На повестке', current_timestamp, current_timestamp, 1, 13, 2),
       ('Упражнения для пресса', 'Сколько, как и почему.', current_timestamp, current_timestamp, 1, 14, 3),
       ('Кроссовки Asics GT-2000 10 GTX', 'Скидка дня', current_timestamp, current_timestamp, 1, 15, 4),
       ('Moda in Kiev 2020', 'Мои фото', current_timestamp, current_timestamp, 1, 16, 5),
       ('Moda in Kiev 2020', 'Все про всех и про все', current_timestamp, current_timestamp, 1, 17, 6),
       ('Самшит вечнозелёный', 'Плотное, вечнозеленое растение с формированием стрижки.', current_timestamp, current_timestamp, 1, 18, 7),
       ('Анекдот про Красную шапочку', '- Красная Шапочка! — воскликнул Серый Волк. - Серая шубка! — воскликнула девочка.', current_timestamp, current_timestamp, 1, 19, 8),
       ('Как быстро и качественно поклеить обои', 'Все, что вы не знали про поклейку обоев.', current_timestamp, current_timestamp, 1, 20, 9),
       ('Самый лучший стол для дачи', 'Как сделать очень удобный стол для дачи', current_timestamp, current_timestamp, 1, 21, 10),
       ('Ветровка 4F HJL20-JKUM002', 'Скидка дня.', current_timestamp, current_timestamp, 1, 15, 4),
       ('Штаны спортивные Nike M NSW CLUB JGGR BB', 'Скидка дня.', current_timestamp, current_timestamp, 1, 15, 4);
